...
const ScreenNavigationContext = createContext<
  ScreenNavigationContextValue | undefined
>(undefined);
...
export const useScreenNavigation = () => {
  ...
  if (!context) {
    throw new Error(
      "useScreenNavigation must be used within a ScreenNavigationProvider"
    );
  }
